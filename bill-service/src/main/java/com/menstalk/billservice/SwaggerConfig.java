package com.menstalk.billservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.billservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Bill Service", "RESTFUL API Document for Bill Service", "1.0.0",
