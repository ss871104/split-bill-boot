package com.menstalk.memberservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.memberservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Member Service", "RESTFUL API Document for Member Service", "1.0.0",
