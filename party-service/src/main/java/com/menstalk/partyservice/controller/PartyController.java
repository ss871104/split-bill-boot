...
public class PartyController {
	...
	public ResponseEntity<String> updateParty(@PathVariable Long partyId, @RequestParam(value="partyName", required=true) String partyName) {
	...
	public ResponseEntity<String> updateQty(@PathVariable Long partyId, @RequestParam(value="memberQty", required=true) Long memberQty) {
