package com.menstalk.partyservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.partyservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Party Service", "RESTFUL API Document for Party Service", "1.0.0",
