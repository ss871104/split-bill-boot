package com.menstalk.notificationservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.notificationservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Notification Service", "RESTFUL API Document for Notification Service", "1.0.0",
